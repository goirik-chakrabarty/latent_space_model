...
pre_path = "/mnt/vast-react/projects/neural_foundation_model/test_upsampling_without_hamming_30.0Hz/"

session_name = "dynamic26872-17-20-Video-021a75e56847d574b9acbcc06c675055_30hz"
session_path = f"{pre_path}{session_name}/"
...
if __name__ == "__main__":
    ...
    cfg["dataloader"]["batch_size"] = 4  # reduced from 8 to avoid OOM; gradient accumulation simulates effective batch_size=8
    ...
    validation_score = standard_trainer(
        ...
        111,
        use_wandb=True,
        wandb_name="single_session_26872_train_test_by_tier",
        loss_function="PoissonLoss",
        verbose=True,
        lr_decay_steps=4,
        lr_init=lr_inint,
        ...
        checkpoint_save_path="../test_training/single_session_26872/",
        loss_accum_batch_n=2,  # accumulate 4 mini-batches of 2 = effective batch size 8
    )
